 ...
 * stops this class loading also stops and no {@link Listener#onLoaded(Products)} method is called.
 */
public interface Inventory {
	...
	/**
	 * Note that this method may return different instances of {@link Products} with different contents.
	 * If you're reloading this inventory consider using {@link #whenLoaded(Listener)} method.
	 *
