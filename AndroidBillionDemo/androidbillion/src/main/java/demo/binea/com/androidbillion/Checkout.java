...
/**
 * <p/>
 * Billing API helper class. Might be used in {@link Activity} or {@link Service} and then its
...
public class Checkout {
	...
	public static interface Listener {
		 ...
		 */
		void onReady(@Nonnull BillingRequests requests, @Nonnull String product,
