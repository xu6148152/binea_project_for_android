...
public interface BillingRequests {
	 ...
	 * @see org.solovyev.android.checkout.ProductTypes
	 */
	int getPurchases(@Nonnull String product, @Nullable String continuationToken,
			@Nonnull RequestListener<Purchases> listener);
	 ...
	 * @return request id
	 */
	int isPurchased(@Nonnull String product, @Nonnull String sku,
			@Nonnull RequestListener<Boolean> listener);
	 ...
	 * @return request id
	 */
	int getSkus(@Nonnull String product, @Nonnull List<String> skus,
			@Nonnull RequestListener<Skus> listener);
	 ...
	 * @return request id
	 */
	int purchase(@Nonnull String product, @Nonnull String sku, @Nullable String payload,
