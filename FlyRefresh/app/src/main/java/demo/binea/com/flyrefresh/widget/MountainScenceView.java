 ...
 */
public class MountainScenceView extends View implements PullHeaderListener{
	...
	public MountainScenceView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	@Override
	public void onPullProgress(PullHeadLayout parent, int state, float factor) {
		float bendFactor;
		if (state == PullHeadLayout.STATE_BOUNCE) {
