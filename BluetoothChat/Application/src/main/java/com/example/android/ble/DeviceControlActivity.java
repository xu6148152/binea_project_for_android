...
public class DeviceControlActivity extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStartDribblingButton = (Button) findViewById(R.id.btn_start_dribbling);
        tv_shoot_count = (TextView) findViewById(R.id.tv_shoot_count);
        mStartShootingButton = (Button) findViewById(R.id.btn_start_shooting);
    ...
    @Override public void onClick(View v) {
        if(mBluetoothLeService.delegate == null){
        ...
        switch (v.getId()){
            case R.id.btn_start_dribbling:
                ...
                if (!isStartDribbling) {
                    mBluetoothLeService.delegate.startDribblingActivity();
                    isStartDribbling = true;
                } else {
                    //mBluetoothLeService.delegate.setEndDribblingListener(new EndDribblingListener() {
                    ...
                    //mBluetoothLeService.delegate.endDribblingActivity();
                    mBluetoothLeService.delegate.endDribblingActivity();
                    //isStartDribbling = !isStartDribbling;
                    //this.runOnUiThread(new Runnable() {
                    //    @Override public void run() {
            ...
            case R.id.btn_start_shooting:
                ...
                if (!isStartShooting) {
                    mBluetoothLeService.delegate.startShootingActivity();
                    isStartShooting = true;
                } else {
                    //mBluetoothLeService.delegate.setEndShootingListener(new EndShootingListener() {
                    //    @Override public void onResponse(boolean isOk) {
                    //        if (isOk) {
                    ...
                    //    }
                    //});
                    //mBluetoothLeService.delegate.endShootingActivity();
                    mBluetoothLeService.delegate.endShootingActivity();
                    isStartShooting = !isStartShooting;
                }
                if(isStartShooting){
            ...
            case R.id.btn_start_raw_stream:
                ...
                if (!isStartRawStream) {
                    ...
                    time.start();
                    FileUtil.createFile();
                    mBluetoothLeService.delegate.startRawStream();
                    isStartRawStream = true;
                } else {
                    //mBluetoothLeService.delegate.setEndRawStreamListener(new EndRawStreamListener() {
                    //    @Override public void onResponse(boolean isOk) {
                    //        if (isOk) {
                    ...
                    //    }
                    //});
                    mBluetoothLeService.delegate.endRawStream();
                    mBluetoothLeService.delegate.endRawStream();
                    isStartRawStream = !isStartRawStream;
                }
    ...
    private void showToastForHintOtherRequestIsStart(){
        Toast.makeText(this, "other request is started, please stop it before you can start a new request", Toast.LENGTH_SHORT).show();
    }
}
