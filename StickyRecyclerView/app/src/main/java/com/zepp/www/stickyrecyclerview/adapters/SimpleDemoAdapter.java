package com.zepp.www.stickyrecyclerview.adapters;
 ...
 * //                  佛祖镇楼                  BUG辟易
 */
public class SimpleDemoAdapter extends SectionAdapter {
    ...
    public class ItemViewHolder extends SectionAdapter.ItemViewHolder implements View.OnClickListener {
        TextView textView;
    ...
    public class HeaderViewHolder extends SectionAdapter.HeaderViewHolder implements View.OnClickListener {
        TextView textView;
        TextView adapterPositionTextView;
        ImageButton cloneButton;
        ImageButton deleteButton;
    ...
    public class FooterViewHolder extends SectionAdapter.FooterViewHolder {
        TextView textView;
        TextView adapterPositionTextView;
    ...
    @Override
    public void onBindItemViewHolder(SectionAdapter.ItemViewHolder viewHolder, int sectionIndex, int itemIndex) {
        Section s = sections.get(sectionIndex);
    ...
    @SuppressLint("SetTextI18n")
    @Override
    public void onBindHeaderViewHolder(SectionAdapter.HeaderViewHolder viewHolder, int sectionIndex) {
        Section s = sections.get(sectionIndex);
    ...
    @Override
    public void onBindGhostHeaderViewHolder(SectionAdapter.GhostHeaderViewHolder viewHolder, int sectionIndex) {
        if (USE_DEBUG_APPEARANCE) {
    ...
    @SuppressLint("SetTextI18n")
    @Override
    public void onBindFooterViewHolder(SectionAdapter.FooterViewHolder viewHolder, int sectionIndex) {
        Section s = sections.get(sectionIndex);
