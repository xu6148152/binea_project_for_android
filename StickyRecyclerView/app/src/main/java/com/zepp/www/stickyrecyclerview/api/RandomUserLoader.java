package com.zepp.www.stickyrecyclerview.api;

import android.text.TextUtils;
import android.util.Log;
import com.zepp.www.stickyrecyclerview.model.Person;
import com.zepp.www.stickyrecyclerview.model.RandomUserResults;
    ...
    public void load(final OnLoadCallback onLoadCallback) {
        ...
        call.enqueue(new Callback<RandomUserResults>() {
            @Override public void onResponse(
                    Call<RandomUserResults> call, Response<RandomUserResults> response) {
            ...
            @Override public void onFailure(Call<RandomUserResults> call, Throwable t) {
