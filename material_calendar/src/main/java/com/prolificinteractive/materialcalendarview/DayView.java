...
class DayView extends CheckedTextView {
    ...
    private int backgroundOffset = 10;
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        if (customBackground != null) {
            ...
            //tempRect.set(tempRect.left + backgroundOffset, tempRect.top + backgroundOffset, tempRect.right - backgroundOffset, tempRect.bottom - backgroundOffset);
            tempRect.inset(backgroundOffset, backgroundOffset);
    ...
    void applyFacade(DayViewFacade facade) {
        ...
        Log.d("textcolor", "textcolor" + (facade.getTextColor() == Color.BLACK));
