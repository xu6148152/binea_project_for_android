...
public class MaterialCalendarView extends ViewGroup {
    ...
    public void goPreviousDate(boolean isSmoothScroll) {
        pager.setCurrentItem(pager.getCurrentItem() - 1, isSmoothScroll);
    }

    public void goNextDate(boolean isSmoothScroll) {
        pager.setCurrentItem(pager.getCurrentItem() + 1, isSmoothScroll);
    }
}
