...
public class BootstrapApplication extends Application {
    ...
    static {
        com.android.tools.fd.common.Log.logging = new Logging() {
            ...
            @Override public void log(Level paramLevel, String paramString) {
                // TODO Auto-generated method stub

            }

            @Override public boolean isLoggable(Level paramLevel) {
                // TODO Auto-generated method stub
                return false;
            }

            @Override public void log(
                    Level paramLevel, String paramString, Throwable paramThrowable) {
                // TODO Auto-generated method stub
    ...
    public BootstrapApplication() {
        if (Log.isLoggable("InstantRun", 2)) {
            Log.v("InstantRun", String.format("BootstrapApplication created. Android package is %s, real application class is %s.", new Object[] {
    ...
    private static void setupClassLoaders(
            Context context, String codeCacheDir, long apkModified) {
    ...
    private void createRealApplication() {
        if (AppInfo.applicationClass != null) {
            ...
            try {
                Class<? extends Application> realClass = (Class<? extends Application>) Class.forName(AppInfo.applicationClass);
                if (Log.isLoggable("InstantRun", 2)) {
                    Log.v("InstantRun",
                          "Created delegate app class successfully : " + realClass + " with class loader " + realClass.getClassLoader());
                }
                Constructor<? extends Application> constructor = realClass.getConstructor(new Class[0]);
