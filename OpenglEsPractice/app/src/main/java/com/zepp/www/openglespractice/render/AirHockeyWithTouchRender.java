...
import com.zepp.www.openglespractice.util.Geometry.Point;
 ...
 * //                  佛祖镇楼                  BUG辟易
 */
public class AirHockeyWithTouchRender implements GLSurfaceView.Renderer {

    private Context mContext;

    public AirHockeyWithTouchRender(Context context) {
    ...
    public void handleTouchPress(float normalizedX, float normalizedY) {
        ...
        Sphere malletBoundingSphere = new Sphere(
                new Geometry.Point(blueMalletPosition.x, blueMalletPosition.y,
