...
public class MainActivity extends Activity
    ...
    private CameraOrientation mCameraOrientation = CameraOrientation.BACK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final File outputFile = new File(Environment.getExternalStorageDirectory(), "camera-test.mp4");
    ...
    private void openCamera(int desiredWidth, int desiredHeight) {
        ...
        for (int i = 0; i < numCameras; i++) {
            ...
            if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                mCameraOrientation = CameraOrientation.FRONT;
        ...
        //mCamera.setDisplayOrientation(getOrientationDegree(true, mCameraOrientation));
    ...
    public int getOrientationDegree(boolean isPreview, CameraOrientation orientation) {
        int cameraId = 0;
        if(orientation == CameraOrientation.BACK){
            cameraId = 0;
        }else{
            cameraId = 1;
        }
