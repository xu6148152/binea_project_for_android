package demo.binea.com.mediacodecdemo.CaptureVideo.gles.newsample;
/*
...
public class GLDrawer2D {
	...
	public static int loadShader(final String vss, final String fss) {
		...
		if (compiled[0] == 0) {
			if (DEBUG) Log.e(TAG,
					"Failed to compile vertex shader:" + GLES20.glGetShaderInfoLog(vs));
		...
		if (compiled[0] == 0) {
			if (DEBUG) Log.w(TAG,
					"Failed to compile fragment shader:" + GLES20.glGetShaderInfoLog(fs));
