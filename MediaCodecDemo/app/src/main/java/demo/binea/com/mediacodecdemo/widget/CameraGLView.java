...
import demo.binea.com.mediacodecdemo.CaptureVideo.gles.newsample.GLDrawer2D;
 ...
 */
public final class CameraGLView extends AutoFitSurfaceView {
...
//			if (DEBUG) Log.i(TAG, "onSurfaceCreated:Gl extensions: " + extensions);
		...
		private final void updateViewport() {
			...
			if (parent != null) {
				...
				Log.i(TAG,
						String.format("view(%d,%d)%f,video(%1.0f,%1.0f)", view_width, view_height,
				...
				case SCALE_CROP_CENTER:
				{
					...
					Log.v(TAG, String.format("size(%1.0f,%1.0f),scale(%f,%f),mat(%f,%f)", width,
							height, scale_x, scale_y, width / view_width, height / view_height));
...
/*					final Size preferedSize = params.getPreferredPreviewSizeForVideo();
					...
					Log.i(TAG, String.format("previewSize(%d, %d)", previewSize.width,
							previewSize.height));
