...
public class CameraToMpegTest extends AndroidTestCase {
    ...
    private void encodeCameraToMpeg() throws IOException {
        ...
        try {
            ...
            final long desiredEnd = startWhen + DURATION_SEC * 1000000000L;
            final SurfaceTexture st = mStManager.getSurfaceTexture();
            //int frameCount = 0;
            ...
            mEncoder.setCallback(new MediaCodec.Callback() {
                ...
                @Override public void onOutputBufferAvailable(MediaCodec codec, int index, MediaCodec.BufferInfo info) {
                    Log.d(TAG, "onOutputBufferAvailable " + info.presentationTimeUs);
                    boolean endOfStream = false;
                    if (System.nanoTime() >= desiredEnd) {
                        codec.signalEndOfInputStream();
                        endOfStream = true;
                        releaseResource();
                        CameraToMpegTest.this.notifyAll();
                    }
    ...
    private static class CodecInputSurface {
        ...
        private void eglSetup() {
            ...
            int[] attribList = {
                    EGL14.EGL_RED_SIZE, 8, EGL14.EGL_GREEN_SIZE, 8, EGL14.EGL_BLUE_SIZE, 8, EGL14.EGL_ALPHA_SIZE, 8, EGL14.EGL_RENDERABLE_TYPE,
                    EGL14.EGL_OPENGL_ES2_BIT, EGL_RECORDABLE_ANDROID, 1, EGL14.EGL_NONE
            };
