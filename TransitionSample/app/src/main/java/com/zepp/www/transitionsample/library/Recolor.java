...
import com.zepp.www.transitionsample.library.util.TransitionUtils;
 ...
 */
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) public class Recolor extends Transition {
    ...
    static {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            TEXTVIEW_TEXT_COLOR = new IntProperty<TextView>() {
                ...
                @Override public void setValue(TextView object, int value) {
    ...
    @Override public Animator createAnimator(
