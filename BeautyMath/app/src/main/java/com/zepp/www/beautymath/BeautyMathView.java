...
/**
 * Created by xubinggui on 4/23/16.
 * //                            _ooOoo_
 * //                           o8888888o
 * //                           88" . "88
 * //                           (| -_- |)
 ...
 * //                  佛祖镇楼                  BUG辟易
 */
public class BeautyMathView extends View {
    ...
    private float speedOuterPoint = SPEED_OUTER_POINT_DEFAULT, speedInnerPoint =
            SPEED_INNER_POINT_DEFAULT;
    ...
    public BeautyMathView(Context context) {
        this(context, null);
    }

    public BeautyMathView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeautyMathView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public BeautyMathView setRadius(float radiusAX, float radiusAY, float radiusBX, float radiusBY) {
        setDefaultRadius();
        if (radiusAX > 0) {
     ...
     */
    public BeautyMathView setDurationSec(int durationSec) {
        if (durationSec > 0) {
     ...
     * set loop count.
     */
    public BeautyMathView setLoopTotalCount(int loopTotalCount) {
        if (loopTotalCount > 0) {
     ...
     */
    public BeautyMathView setSpeed(int speedOuterPoint, int speedInnerPoint) {
    ...
    /**
     * set a BeautyMathViewParameters.
     */
    public void setParameters(BeautyMathViewParameters BeautyMathViewParameters) {
        this.setAllEightParameters(BeautyMathViewParameters.radiusAX, BeautyMathViewParameters.radiusAY,
                BeautyMathViewParameters.radiusBX, BeautyMathViewParameters.radiusBY,
                BeautyMathViewParameters.durationSec, BeautyMathViewParameters.loopTotalCount,
                BeautyMathViewParameters.speedOuterPoint, BeautyMathViewParameters.speedInnerPoint);
    }

    /**
     * You can create your own parameters as below.
     */
    public enum BeautyMathViewParameters {
         ...
         */
        BeautyMathViewParameters(float radiusAX, float radiusAY, float radiusBX, float radiusBY,
