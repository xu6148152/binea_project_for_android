package com.zepp.www.combinationavatar.widget;
...
public class JoinBitmaps {
    ...
    public static void join(
            Canvas canvas, int dimension, List<Bitmap> bitmaps, int count, float[] size) {
        join(canvas, dimension, bitmaps, count, size, 0.15f);
    }

    public static void join(
            Canvas canvas, int dimension, List<Bitmap> bitmaps, float gapSize) {
        if (bitmaps == null) {
            return;
        }
        int count = Math.min(bitmaps.size(), JoinLayout.max());
    ...
    public static void join(
            Canvas canvas, int dimension, List<Bitmap> bitmaps, int count, float[] size, float gapSize) {
        if (bitmaps == null) {
            return;
        }
        // 旋转角度
    ...
    public static Bitmap createMaskBitmap(
            Bitmap bitmap, int viewBoxW, int viewBoxH, int rotation, float gapSize) {
    ...
    public static Bitmap createBitmap(
            int width, int height, List<Bitmap> bitmaps, int count, float[] size) {
        return createBitmap(width, height, bitmaps, count, size, 0.15f);
    }

    public static Bitmap createBitmap(
            int width, int height, List<Bitmap> bitmaps, int count, float[] size, float gapSize) {
