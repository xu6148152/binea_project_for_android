...
import demo.binea.com.beautyprogressbar.factory.LeafFactory;
...
public class LeafLoadingView extends View {
	...
	// 叶子飘动一个周期所花的时间
	public static long mLeafFloatTime = LEAF_FLOAT_TIME;
	// 叶子旋转一周需要的时间
	...
	public LeafLoadingView(Context context, AttributeSet attrs) {
		...
		mLeftMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, LEFT_MARGIN, dm);
		mRightMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, RIGHT_MARGIN, dm);
