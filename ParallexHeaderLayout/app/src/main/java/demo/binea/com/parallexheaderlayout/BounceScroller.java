...
public class BounceScroller extends RelativeLayout implements BounceListener{
	...
	private View mParallexHeaderView;
	...
	private boolean offsetContent(int offset) {
		...
		if (mParallexHeaderView != null){
			mParallexHeaderView.setTranslationY(mContentView.getTop() / 2);
			//mParallexHeaderView.offsetTopAndBottom(offset);
		}
	...
	public void setParallexHeaderView(View view){
		mParallexHeaderView = view;
	}
